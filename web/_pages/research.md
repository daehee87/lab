...
<font color=purple>**힙 레이아웃 조작: **</font>
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/defrag.png){: style="width: 40%; float: left; margin: 10px 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/fuzzhome2.png){: style="width: 80%; float: left; margin: 0px  0px"}
