...
<div class="row">
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
      ...
      <p>현대자동차/삼성/네이버 기술교류회</p>
    </div>
  </div>
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
      <a href="{{ site.url }}{{ site.baseurl }}/images/gal/a60.png" data-lightbox="gallery" class="gallery-link">
        <img src="{{ site.url }}{{ site.baseurl }}/images/gal/a60.png" class="img-responsive" width="100%" alt="Description 1">
      </a>
      <p>싱가포르 DSTA 연구소 국제교류행사</p>
    </div>
  </div>
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
  ...
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
      ...
      <p>CODEBLUE 보안 컨퍼런스 참석 및 운영 (김민서 석사과정, 윤석찬 학부인턴)</p>
    </div>
  </div>
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
      <a href="{{ site.url }}{{ site.baseurl }}/images/gal/a53.png" data-lightbox="gallery" class="gallery-link">
        <img src="{{ site.url }}{{ site.baseurl }}/images/gal/a53.png" class="img-responsive" width="100%" alt="Description 1">
      </a>
      <p>2025 DEFCON Bahrain 일본 보안기업과 AeroSpace 부스 공동운영</p>
    </div>
  </div>
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
  ...
  <div class="col-sm-6 clearfix gallery-item">
    <div class="well">
      <a href="{{ site.url }}{{ site.baseurl }}/images/gal/a3.png" data-lightbox="gallery" class="gallery-link">
        <img src="{{ site.url }}{{ site.baseurl }}/images/gal/a3.png" class="img-responsive" width="100%" alt="Description 1">
      </a>
      <p>2024 우주안보학회 워크숍</p>
    </div>
  </div>
